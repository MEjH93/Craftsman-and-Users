...
public class Podaci {
    ...
    static{
        ...
        podaci.put("Mitra", new Korisnik("Mitra", "Vesovic", "0601234567", "Djusina 2", "Mitra", "lozinka", Korisnik.Vrsta.KUPAC, null));
        podaci.put("Drazen", new Korisnik("Drazen", "Draskovic", "067654321", "Djuke Dinica 2", "Drazen", "lozinka", Korisnik.Vrsta.KUPAC, null));
        podaci.put("Milan", new Korisnik("Milan", "Vukmirovic", "062444555", "Ruzveltova 17", "Milan", "lozinka", Korisnik.Vrsta.MAJSTOR, Milan));
        podaci.put("Mihailo", new Korisnik("Mihailo", "Zi Djordjevic", "063000111", "Pupinova 0", "Mihailo", "lozinka", Korisnik.Vrsta.MAJSTOR, Mihailo));
        ...
        Zahtev z1 = new Zahtev("Milesevska 2", "Zvezdara", 0, podaci.get("Mitra"));
        z1.izvrsenZahtev = i1;
        ...
        Zahtev z2 = new Zahtev("Toplicka 1", "Zvezdara", 1, podaci.get("Drazen"));
        z2.izvrsenZahtev = i2;
        ...
        Zahtev z3 = new Zahtev("Ruzveltova 44", "Zvezdara", 1, podaci.get("Mitra"));
        z3.majstor = podaci.get("Mihailo");
        z3.status = 3;
        //nema placeno/neplaceno jer nije prihvacen tj. odbijen je

        Zahtev z4 = new Zahtev("Djuriceva 1", "Zvezdara", 0, podaci.get("Drazen"));
        z4.status = 0;
        //nema placeno/neplaceno, niko jos nije dirnuo zahtev



        Zahtev z5 = new Zahtev("Sarska 5", "Vracar", 0, podaci.get("Drazen"));
