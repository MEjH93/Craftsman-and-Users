...
public class GuestSearchActivity extends AppCompatActivity {
    ...
    private EditText CenaOdGS, CenaDoGS, PosaoGS, SpecijalneTehnikeGS, OcenaDoGS, OcenaOdGS, IskustvoOdGS, IskustvoDoGS;
    private Button PretraziGS, NazadGS;
    private EditText DatumOdGS, DatumDoGS;
    private CheckBox HitnostGS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CenaOdGS = (EditText) findViewById(R.id.CenaOdGS);
        CenaDoGS = (EditText) findViewById(R.id.CenaDoGS);
        OcenaOdGS = (EditText) findViewById(R.id.OcenaOdGS);
        OcenaDoGS = (EditText) findViewById(R.id.OcenaDoGS);
        IskustvoOdGS = (EditText) findViewById(R.id.IskustvoOdGS);
        IskustvoDoGS = (EditText) findViewById(R.id.IskustvoDoGS);
        PosaoGS = (EditText) findViewById(R.id.PosaoGS);
        SpecijalneTehnikeGS = (EditText) findViewById(R.id.SpecijalneTehnikeGS);

        PretraziGS = (Button) findViewById(R.id.PretraziGS);
        NazadGS = (Button) findViewById(R.id.NazadGS);

        DatumOdGS = (EditText) findViewById(R.id.DatumOdGS);
        DatumDoGS = (EditText) findViewById(R.id.DatumDoGS);

        HitnostGS = (CheckBox) findViewById(R.id.HitnostGS);

        NazadGS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nazad_redirect();
            }
        });
        PretraziGS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pretrazi_redirect();
            }
    ...
    public void pretrazi_redirect(){
        ...
        String cenaOd = CenaOdGS.getText().toString();
        String cenaDo = CenaDoGS.getText().toString();
        String ocenaOd = OcenaOdGS.getText().toString();
        String ocenaDo = OcenaDoGS.getText().toString();
        String iskustvoOd = IskustvoOdGS.getText().toString();
        String iskustvoDo = IskustvoDoGS.getText().toString();
        ...
        String posao = PosaoGS.getText().toString();
        String specijalneTehnike = SpecijalneTehnikeGS.getText().toString();
        ...
        if(cenaod < -1 || cenado < -1 || ocenaod < -1 || ocenado < -1 || iskustvood < -1 || iskustvodo < -1){
            ...
            for(int i=0; i<majstori.length; i++) {
                ...
                int[] datumod = okdatum(DatumOdGS.getText().toString());
                int[] datumdo = okdatum(DatumDoGS.getText().toString());
        ...
        if(porukaP.equals("")) {
            ...
            for(int i=0; i<korisnici.length; i++){
                if(mapica.get(korisnici[i]).booleanValue() == true){
                    ...
                    e1.setText("User: " + korisnici[i].korisnickoime);
                    tr.addView(e1, 350, 50);
                    tl.addView(tr, redovi++);

                    tr= new TableRow(this);
                    e1 = new TextView(this);
                    e1.setText("Ime: " + korisnici[i].ime);
                    tr.addView(e1, 350, 50);
                    tl.addView(tr, redovi++);

                    tr= new TableRow(this);
                    e1 = new TextView(this);
                    e1.setText("Prezime: " + korisnici[i].prezime);
                    tr.addView(e1, 350, 50);
                    tl.addView(tr, redovi++);

                    tr= new TableRow(this);
                    e1 = new TextView(this);
                    e1.setText("Adresa: " + korisnici[i].adresa);
                    tr.addView(e1, 350, 50);
                    tl.addView(tr, redovi++);

                    tr= new TableRow(this);
                    e1 = new TextView(this);
                    e1.setText("Broj: " + korisnici[i].broj);
                    tr.addView(e1, 350, 50);
                    tl.addView(tr, redovi++);
    ...
    public void majstor_view_guest(){
        Intent i = new Intent(this,GuestMajstorActivity.class);
        startActivity(i);
    }
